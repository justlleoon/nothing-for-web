...
function startCounter(){
  i = 0;
  $("#startButton").hide()
  $('#nothing-counter').html("Wait and stay <span>steady</span>...");
...
function stopAddI(){
  ...
  $("#nothing-counter").html(`You lost and did <span>Nothing</span> for ${i} seconds! Refresh the page to play again.`);
}
